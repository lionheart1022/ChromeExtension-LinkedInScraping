...
$.get(link, function(data) {
    	...
    	var name = '', headline = '', locality = '';
    	var industry = '', twitter = '', currentCompanyID = '';
    	var currentCompanyName = '', currentCompanyLink = '';
    	var currentCompanyStart = '', firstName = '', lastName = '';
    	var education = '', connections = '', skills = '';
    	var email = '', email1 = '', phone = '', interests = '';
    	var link1 = '', companyWebsite = '', companyType = "";
		var headQuaters = "", companySize = "", companyFounded = "";
		var title = '',searchdescription='', Field19='';
		var summary='';
